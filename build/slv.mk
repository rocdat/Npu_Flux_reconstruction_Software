...
INCDIR = $(sort $(HDF5DIR) $(SZIPDIR) $(CGNSDIR) $(METISDIR))
LIBDIR = $(sort $(HDF5DIR) $(SZIPDIR) $(CGNSDIR) $(METISDIR))

FINC = $(foreach i,$(INCDIR),-I$(i)/include) -I$(SRCDIR) $(MKLINC) $(OTHERINCDIR)
...
$(EXECUTABLE): $(OBJS) $(COBJS)
	...
	if [ -d $(EXEDIR) ] ; then /bin/mv -f $(EXECUTABLE) $(EXEDIR)/$(EXECUTABLE) ; fi
